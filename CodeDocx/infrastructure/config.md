...
- **存储路径**：`data_dir / sqlite_path / faiss_index_dir / relation_faiss_index_dir`
- **Neo4j**：`neo4j_uri / neo4j_username / neo4j_password`
- **Reranker**：`reranker_enabled / reranker_api_url / reranker_api_key / reranker_model / reranker_top_n`
